...
const searchedProducts = computed(
  () => products.value.filter((product) => product.title.toLowerCase().includes(searchQuery.value.toLowerCase())),
);
</script>
...
<template>
  ...
  <CardList :products="searchedProducts" :is-products-loading="isProductsLoading" />
</template>
